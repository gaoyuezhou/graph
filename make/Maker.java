...
class Maker {
    ...
    void readFileAges(String fileInfoName) {
        ...
        try {
            ...
            error("Error: no such file for make:)");
        }
    }
    ...
    class MakeTraversal extends DepthFirstTraversal {
        ...
        protected boolean postVisit(int v0) {
            if (_depends.successors(v0) == null) {
                return false;
            }
        ...
        protected void processSuccessors(int u) {
            ...
            for (int i: _depends.successors(u)) {
                if (processSuccessor(u, i)) {
                    children.add(i);
                }
            }
            while (!children.isEmpty()) {
                _fringe.add(children.pollLast());
            }
        }
